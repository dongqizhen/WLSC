                ...
                <div className="itemText">
                    ...
                    <div className="brandAndModel clearfix">
                        <div className="wordWrap brandBox left">
                            <span>品牌:</span>
                            <span className="brandName">{this.props.itemObj.brandName}</span>
                        </div>
                        <div className="wordWrap modelBox right">
                            <span>型号:</span>
                            <span className="modelName">{this.props.itemObj.modelName}</span>
                        </div>
                    </div>
                    <div className="saleNumAndPrice clearfix">
                        <div className="left saleNum">
                            <span>销量:</span>
                            <span className="number">{this.props.itemObj.saleNumber}</span>
                        </div>
                        <div className="right price">
                            <span className="priceImg">￥</span>
                            <span className="priceValue">{this.props.itemObj.price}</span>
                        </div>
                    </div>
